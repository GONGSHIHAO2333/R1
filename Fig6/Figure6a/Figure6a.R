...
diversity_measures <- unique(c(
  "Denitrification_Bacteria", "Denitrification_Archaea", "Denitrification_Fungi",
  "DNR_Bacteria", "DNR_Archaea", "DNR_Fungi"
))
...
ggsave(
  file.path(output_dir, "fig6a.pdf"),
  width = 12, height = 6, bg = "white"
)
ggsave(
  file.path(output_dir, "fig6a.tiff"),
  width = 12, height = 6, bg = "white", dpi = 300
)

write.csv(results, file.path(output_dir, "fig6a.csv"), row.names = FALSE)